...
class TaskA2 {
    ...
    System.out.println("Моё любимое стихотворение:\n");
       String a = "Как бестолковы числа эти,";
       String b = "Какой сумбур в календаре;";
       String c = "Теперь зима уж на дворе,";
       String d = "А мне вот довелось во всем ее расцвете,";
       String e = "В ее прелестнейшей поре,";
       String f = "Приветствовать Весну лишь в позднем ноябре.";
       String g = "===========================================";
