...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String a = "Перед стихом должна быть выведена строка \"Мое любимое стихотворение:\".";
        String b = "Программа должна выводить текст";
        String c = "Выводимый текст должен состоять не меньше, чем из пяти строк (пустые строки - это тоже строки).";
        String d = "В выводимом тексте должно быть не менее, чем 50 символов.";
        String e = "Команд System.out.println в коде должно быть максимум две.";
