...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String a="Ехали медведи на велосипеде";
        String b="A за ними кот задом наперед";
        String c="A за ним комарики на воздушком шарике";
        String d="Зайчики в трамвайчике, жаба на метле";
